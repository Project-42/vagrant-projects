...
/u01/app/21.3.0.0/grid/gridSetup.sh -ignorePrereq -waitforcompletion -silent \
    ...
    oracle.install.crs.config.clusterName=rac1-c \
    oracle_install_crs_ConfigureMgmtDB=false \
    oracle.install.crs.config.clusterNodes=rac1-node1.localdomain:rac1-node1-vip.localdomain:HUB,rac1-node2.localdomain:rac1-node2-vip.localdomain:HUB \
